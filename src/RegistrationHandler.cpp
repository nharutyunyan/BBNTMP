...
void RegistrationHandler::processRegistrationStatus(const RegistrationState::Type state)
{
    ...
    case BbmRegistrationProgress::Started:
        ...
        if (m_context.registrationState() == RegistrationState::Unknown) {
            ...
            // status.
            qDebug() << "BBM Social Platform access state is UNKNOWN; waiting for the initial status";
            return;
        }
        // Start registration.
...
//        break;
    ...
    case RegistrationState::BlockedByRIM:
        m_statusMessage = tr("Disconnected by BlackBerry. BlackBerry is preventing this "
    ...
    case RegistrationState::MaxAppsReached:
        m_statusMessage = tr("There are too many apps connected to BBM. "
